...
public class ParticipantTest {
    ...
    public static void setUpClass() {
        ...
        participant.addLift(Lift.LiftType.CLEANANDJERK, true);
        participant.setCurrentWeight(15);
        participant.addLift(Lift.LiftType.CLEANANDJERK, true);
        participant.setCurrentWeight(20);
        participant.addLift(Lift.LiftType.CLEANANDJERK, false);
        participant.addLift(Lift.LiftType.SNATCH, true);
        participant.setCurrentWeight(25);
        participant.addLift(Lift.LiftType.SNATCH, false);
        participant.addLift(Lift.LiftType.SNATCH, false);
    ...
    public void testGetBestCleanAndJerk() throws Exception {
        assertEquals(15, participant.getBestCleanAndJerk());
    }

    @Test
    public void testGetBestSnatch() throws Exception {
        assertEquals(20, participant.getBestSnatch());
    }
}